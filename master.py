...
def rutina():
    ...
    subprocess.call('start /wait python servidor.py 8001', shell=True) #Frames ida
    subprocess.call('start /wait python servidor.py 8002', shell=True) #Frames regreso


os.system("python cliente.py video.mp4 8000")
